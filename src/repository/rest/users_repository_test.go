...
import (
	...
	"github.com/davidricoleon/golang-restclient/rest"
...
func TestLoginUserTimeOutFromApi(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		ReqBody:      `{"email": "a@gmail.com", "password": "admin"}`,
		RespHTTPCode: 400,
		RespBody:     ``,
	})
	respository := usersRepository{}

	user, err := respository.LoginUser("a@gmail.com", "admin")
	assert.Nil(t, user)
	assert.NotNil(t, err)
...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "david", "last_name": "León", "email": "davidac_02@live.com"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "alvarez", user.LastName)
	assert.EqualValues(t, "davidac_02@live.com", user.Email)
}
